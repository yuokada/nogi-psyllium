...
- タブ列右側の「リンクをコピー」ボタン左にある月アイコンボタンで、ライト / ダークテーマを切り替える
...
- センターカードの枠線・シャドウと 👑 バッジは、テーマ別の CSS カスタムプロパティで定義する

| テーマ | ボーダー | シャドウ | バッジ背景 | バッジテキスト |
|--------|----------|----------|------------|----------------|
| ライト | `#f0c030` | `0 2px 8px rgba(240, 192, 48, 0.4)` | `#fff9e6` | `#8a6500` |
| ダーク | `#ffe082` | `0 2px 10px rgba(255, 224, 130, 0.32)` | `#463b15` | `#ffe082` |
